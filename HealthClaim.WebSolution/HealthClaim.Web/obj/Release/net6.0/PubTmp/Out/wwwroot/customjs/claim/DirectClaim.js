...
var fileData = [];
var uploadDetails = { AdmissionAdvice: [], Diagnosis: [], Procedure: [], EstimateAmount: [], ITRIncomeProof: [], FinalHospitalBill: [], DischargeSummary: [], InvestigationReports: [], RegdCertificate: [], ExemptionLetter: [], PostTreatment: [] };
