...
function bindTableClaimApproved() {
    ...
    var url = apiBaseUrl + "/api/Claim/GetClaimRequest/" + recipientId.toString();
        ...
        success: function (response) {
            ...
            $.each(response.data, function () {
                var rowAdvanceApproved = ` <tr>
                            ...
                            <td>
                                ${this.employeeName} ( ${this.directClaimId})                               
                            </td>
...
function claimed_app(empId, patientName, relation, directClaimId, empname, pId) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (JsonData.preHospitalizationExpenses.medicineBillAmount == null) {
                alert('no pre');
            }
            else {
                ////
