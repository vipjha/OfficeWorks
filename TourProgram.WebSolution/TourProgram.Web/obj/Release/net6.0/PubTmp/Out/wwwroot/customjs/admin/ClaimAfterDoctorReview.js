...
function bindTableClaimApproved() {
    ...
    var url = apiBaseUrl + "/api/Claim/GetClaimRequest/" + recipientId.toString()+"/2";
        ...
        success: function (response) {
            ...
            $.each(response.data, function () {
                var rowAdvanceApproved = ` <tr>
                            ...
                            <td>
                                <a onclick="claimed_app(${this.empId},'${this.patientName}','${this.relation}','${this.directClaimId}','${this.employeeName}' ,'${this.patientId}','${this.claimId}' )" class="btn btn-primary">Details</a>&nbsp;&nbsp;
                            </td>
                        </tr>`;
