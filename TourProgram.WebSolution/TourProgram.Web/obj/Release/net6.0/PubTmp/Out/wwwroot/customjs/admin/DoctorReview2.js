...
function btnSendtoHr_Click(e) {
    ...
    formDataNew.append('AddmisionAdviseComment', $("#textAreaAdmissionAdvise").val());
    formDataNew.append('DischargeSummaryComment', $("#textAreaDischargeSummary").val());
    formDataNew.append('InvestigationReportComment', $("#textAreaInvestigationReport").val());
    formDataNew.append('IsSpecialDisease', radioSpecialDiseaseYesDoctor.checked);
    formDataNew.append('IsTaxable', false);
    formDataNew.append('Comment_1', $("#textAreaAdd1").val());
    formDataNew.append('Comment_2', $("#textAreaAdd2").val());
    formDataNew.append('Comment_3', $("#textAreaAdd3").val());
