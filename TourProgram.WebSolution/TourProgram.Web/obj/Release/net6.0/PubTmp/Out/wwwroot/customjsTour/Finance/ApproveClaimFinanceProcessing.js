                ...
                $.each(response.data, function () {
                    if (this.status.toUpperCase().includes('CLARIFICATION')) {
                        ...
                        var rowClarification = `<tr>
                            ...
                            <td><button onclick="tourDetails_Click(${this.tourId},'Clarification')" type="button" id="btnDetails" class="btn btn-primary mb-2">Detail</button>
                        ...
                        <td>${countClaim}</td>
                            ...
                            <td><button onclick="tourDetails_Click(${this.tourId},'Details')" type="button" id="btnDetails" class="btn btn-primary mb-2">Detail</button>
...
function calculateSumOfApprovedAmount() {
    ...
    $("#tdAdvanceTakenClaim").html(totalAdvanceRequested);
...
function getTransportationDetailsForPost() {
    ...
    for (var e of $("#tbodyTransportation > tr")) {
        var i = e.id.split('_')[1];
        var obj = { id: $("#inputTransportationId_" + i).val(), approvedAmount: $("#inputTransportationApprovedAmount_" + i).val() };
...
function getAccomodationDetailsForPost() {
    ...
    for (var e of $("#tbodyAccomodationDetails > tr")) {
        var i = e.id.split('_')[1];
        var obj = { id: $("#inputAccomodationId_" + i).val(), approvedAmount: $("#inputAccommodationApprovedAmount_" + i).val() };
...
function getDADetailsForPost() {
    ...
    for (var e of $("#tbodyDA > tr")) {
        var i = e.id.split('_')[1];
        var obj = { id: $("#inputDAId_" + i).val(), approvedAmount: $("#inputDAApprovedAmount_" + i).val() };
...
function getLeaveDetailsForPost() {
    ...
    for (var e of $("#tbodyLeave > tr")) {
        var i = e.id.split('_')[1];
        var obj = { id: $("#inputLeaveId_" + i).val(), approvedAmount: $("#inputLeaveApprovedAmount_" + i).val() };
    ...
    function loadTransportationDetails(dataTransportation) {
        ...
        for (var e of dataTransportation) {
            ...
            var trTransportation = `<tr id="trTransportation_${count}">
                            ...
                            <td>
                                <input readonly onfocusout="calculateApprovedAmount_FocusOut(this)" value="${e.claimedAmount}" id="inputTransportationApprovedAmount_${count}" type="text" class="form-control amt-control" value="0">
                            </td>
                            <td>
                                <input id="inputTransportationRemark_${count}" type="text" class="form-control amt-control" readonly value="NA">
                            </td>
                        </tr>`;
    ...
    function loadAccomodationDetails(dataAccomodation) {
        ...
        for (var e of dataAccomodation) {
            ...
            var trAcomodation = `<tr id="trAcomodation_${count}">
                            ...
                            <td>
                                <input readonly value="${e.claimedAmount}" onfocusout="calculateApprovedAmountAccomodation_FocusOut(this)" type="text" class="form-control amt-control" id="inputAccommodationApprovedAmount_${count}">
                            </td>
                            <td>
                                <input type="text" class="form-control amt-control" readonly id="inputAccommodationRemarks_${count}">
                            </td>
                            <td>
    ...
    function loadDADetails(dataDA) {
        ...
        for (var e of dataDA) {
            ...
            var trDA = `<tr id="trDA_${count}">
                                ...
                                <td>
                                    <input readonly onfocusout="calculateApprovedAmountDA_FocusOut(this)"  type="text" class="form-control" value="${e.amount}" id="inputDAApprovedAmount_${count}">
                                </td>
                                <td>
                                    <input type="text" class="form-control remarks" readonly id="inputDARemarks_${count}">
                                </td>
                            </tr>`;
            tbodyDA.append(trDA);
        }
    ...
    function loadLeaveDetails(dataLeave) {
        ...
        for (var e of dataLeave) {
            ...
            var trLeave = `<tr id="trLeave_${count}">
                            ...
                            <td>
                                <input readonly onfocusout="calculateApprovedAmountLeave_FocusOut(this)" value="${e.amount}" type="text" class="form-control" id="inputLeaveApprovedAmount_${count}">
                            </td>
                            <td>
                                <input  type="text" class="form-control value="NA" remarks" readonly id="inputLeaveRemarks_${count}">
                            </td>
                        </tr>`;
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.data.isAdvanceRequired) {
                    ...
                    $("#spanAdvanceApprovedBy").html(response.data.advanceApprovedBy + "(" + response.data.advanceApprovedDesignation + ", " + response.data.advanceApprovedDepartment + ")");
                }
                else {
